        ...
        <div className="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
          ...
          <div
            className={`${
              ...
              bg-white shadow-md lg:bg-transparent lg:dark:bg-transparent lg:shadow-none
               dark:bg-gray-900 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100
