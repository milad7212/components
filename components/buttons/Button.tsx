  ...
  return (
    <div className=" grid grid-cols-2  md:grid-cols-6 gap-2">
      ...
      <a
        ...
        href="/download"
      >
        <span className="absolute inset-0 translate-x-0 translate-y-0 bg-indigo-600 transition-transform group-hover:translate-y-0.5 group-hover:translate-x-0.5" />
        <span className="relative block border border-current bg-white px-8 py-3">
          Download
        </span>
      </a>
      ...
      <a
        ...
        href="/download"
      >
        <span className="absolute inset-y-0 right-0 w-[2px] bg-indigo-600 transition-all group-hover:w-full group-active:bg-indigo-500" />
        <span className="relative text-sm font-medium text-indigo-600 transition-colors group-hover:text-white">
          Download
        </span>
      </a>
      ...
      <a
        ...
        href="/download"
      >
        <span className="absolute inset-x-0 top-0 h-[2px] bg-indigo-600 transition-all group-hover:h-full group-active:bg-indigo-500" />
        <span className="relative text-sm font-medium text-indigo-600 transition-colors group-hover:text-white">
          Download
        </span>
      </a>
      ...
      {/* Dribbble */}
      <a
        className="inline-flex items-center rounded border-2 border-[#ea4c89] bg-[#ea4c89] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#ea4c89] focus:outline-none focus:ring active:opacity-75"
        href="/dribbble"
        target="_blank"
        rel="noreferrer"
      >
      ...
      {/* LinkedIn */}
      <a
        className="inline-flex items-center rounded border-2 border-[#0077b5] bg-[#0077b5] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#0077b5] focus:outline-none focus:ring active:opacity-75"
        href="/linkedin"
        target="_blank"
        rel="noreferrer"
      >
